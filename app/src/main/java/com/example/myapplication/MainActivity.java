...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAct2.setOnClickListener(btnActiviteDeux);
    ...
    View.OnClickListener btnEnvoyerOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick (View v) {
            popUp( "la valeur valeur saisie = " + getTxtValeur());
        }
    };
    ...
    View.OnClickListener btnActiviteDeux = new View.OnClickListener() {
        @Override
        public void onClick (View v) {
            Intent intent = new Intent(v.getContext(), SecondActivity.class);
            EditText edttxt1 = (EditText) findViewById(R.id.EditTxtValeur);
            intent.putExtra( "textact2" , edttxt1.getText().toString() ) ;
